    ...
    <main class="main">
        ...
        <div class="cards-container">
            <div class="card" style="width: 18rem;">
                <img src="../img/logo_html.png" class="card-img-top" alt="logo officiel du langage HTML">
                <div class="card-body">
            ...
            <div class="card" style="width: 18rem;">
                <img src="../img/CSS-Logo.png" class="card-img-top" alt="logo officiel du langage CSS">
                <div class="card-body">
            ...
            <div class="card" style="width: 18rem;">
                <img src="../img/logo_javascript.png" class="card-img-top" alt="logo officiel du langage Javascript">
                <div class="card-body">
